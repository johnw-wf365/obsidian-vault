# Calculator Platform Infrastructure Plan
...
1. **Review and approve this plan** — Elon/board
2. **Unblock dependencies** — human actions above
3. **Run Terraform** — provision staging + production
4. **Deploy initial app** — once Zoe's calculator code is ready
5. **Monitor and iterate** — validate performance, scale as needed
